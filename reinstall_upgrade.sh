...
EXTRA_VARS="site_url=http://upgrade.drupal.192.168.56.132.xip.io workflow_type=sql settings_site_folder=upgrade mysql_db=drupal_upgrade stage_file_proxy=true"
